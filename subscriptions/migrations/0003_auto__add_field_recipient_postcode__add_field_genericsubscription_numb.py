...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipient.postcode'
        db.add_column(u'subscriptions_recipient', 'postcode',
        ...
        # Adding field 'GenericSubscription.first_borked_call_time'
        db.add_column(u'subscriptions_genericsubscription', 'first_borked_call_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipient.postcode'
        db.delete_column(u'subscriptions_recipient', 'postcode')
        ...
        # Deleting field 'GenericSubscription.first_borked_call_time'
        db.delete_column(u'subscriptions_genericsubscription', 'first_borked_call_time')
    ...
    models = {
        ...
        u'subscriptions.genericsubscription': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number_borked_calls': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
