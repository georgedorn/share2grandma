...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile._Profile__s2g_email'
        db.delete_column(u'subscriptions_profile', '_Profile__s2g_email')

        # Adding field 'Profile.s2g_email'
        db.add_column(u'subscriptions_profile', 's2g_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Profile._Profile__s2g_email'
        db.add_column(u'subscriptions_profile', '_Profile__s2g_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)

        # Deleting field 'Profile.s2g_email'
        db.delete_column(u'subscriptions_profile', 's2g_email')
