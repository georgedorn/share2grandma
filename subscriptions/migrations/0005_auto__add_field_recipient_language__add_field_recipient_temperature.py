...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipient.language'
        db.add_column(u'subscriptions_recipient', 'language',
                      self.gf('django.db.models.fields.CharField')(default='en-us', max_length=12),
                      keep_default=False)

        # Adding field 'Recipient.temperature'
        db.add_column(u'subscriptions_recipient', 'temperature',
                      self.gf('django.db.models.fields.CharField')(default='F', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipient.language'
        db.delete_column(u'subscriptions_recipient', 'language')

        # Deleting field 'Recipient.temperature'
        db.delete_column(u'subscriptions_recipient', 'temperature')
    ...
    models = {
        ...
        u'subscriptions.recipient': {
            ...
            'dailywakeup_hour': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
