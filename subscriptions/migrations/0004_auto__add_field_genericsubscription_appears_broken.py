...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GenericSubscription.appears_broken'
        db.add_column(u'subscriptions_genericsubscription', 'appears_broken',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GenericSubscription.appears_broken'
        db.delete_column(u'subscriptions_genericsubscription', 'appears_broken')
