...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Recipient.dailywakeup_hour'
        db.add_column(u'subscriptions_recipient', 'dailywakeup_hour',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Recipient.dailywakeup_hour'
        db.delete_column(u'subscriptions_recipient', 'dailywakeup_hour')
