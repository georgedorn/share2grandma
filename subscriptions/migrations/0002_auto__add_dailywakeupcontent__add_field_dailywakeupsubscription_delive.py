...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailyWakeupSubscription.delivery_time'
        db.add_column(u'subscriptions_dailywakeupsubscription', 'delivery_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DailyWakeupSubscription.delivery_bucket'
        db.add_column(u'subscriptions_dailywakeupsubscription', 'delivery_bucket',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    models = {
        ...
        u'subscriptions.recipient': {
            ...
            'bucket': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
