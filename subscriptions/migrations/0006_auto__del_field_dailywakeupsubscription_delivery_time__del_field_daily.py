...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DailyWakeupSubscription.delivery_time'
        db.delete_column(u'subscriptions_dailywakeupsubscription', 'delivery_time')

        # Deleting field 'DailyWakeupSubscription.delivery_bucket'
        db.delete_column(u'subscriptions_dailywakeupsubscription', 'delivery_bucket')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DailyWakeupSubscription.delivery_time'
        raise RuntimeError("Cannot reverse this migration. 'DailyWakeupSubscription.delivery_time' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DailyWakeupSubscription.delivery_bucket'
        raise RuntimeError("Cannot reverse this migration. 'DailyWakeupSubscription.delivery_bucket' and its values cannot be restored.")
